...
/* ================================================================
 * Compute the 67 WOTS chain lengths.
 *
 * SHA2-256f:
 *
 * W = 16
...
/* ================================================================
 * Set XMSS/WOTS keypair address.
 *
 * SHA2 address bytes10..13.
 * ================================================================ */
    ...
    int worker_id)
{
    ...
    /*
     * ============================================================
     * Same request context as original graph input.
     * ============================================================
     */
    ...
    /*
     * ============================================================
     * Compute message-dependent WOTS steps once.
     * ============================================================
     */
    ...
    /*
     * ============================================================
     * Precompute SHA256 seeded state once.
     * ============================================================
     */
         ...
         chain += NUM_WORKERS)
    {
        ...
        /*
         * Signing WOTS key is target_leaf_idx.
         */
        ...
        /*
         * chain address byte17.
         */
        addr[4] =
            (addr[4] & 0xFF00FFFFU) |
            (((uint32_t)chain & 0xFFU) << 16);
...
/* ================================================================
 * Eight ADF entry functions.
 *
 * Same hardware algorithm; worker ID is compile-time fixed by
 * wrapper.
 * ================================================================ */
