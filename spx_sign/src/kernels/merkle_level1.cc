    ...
    output_stream<uint32_t> *__restrict output)
{
    ...
    /*
     * ============================================================
     * Metadata input stays identical to old merkle_collect:
     *
     * pub_seed[8]
     * wots_msg[8]
     * base_addr[8]
    ...
    /*
     * ============================================================
     * Precompute SHA512 seeded state ONCE.
     * ============================================================
     */
     ...
     *
     * Level2 can initialize before first parent appears.
     */
    write_header(
        output,
        seed_state,
         ...
         ++arrival)
    {
        ...
        )
        {
            ...
            /*
             * Immediately stream parent to Level2.
             */
            write_node(
                output,
                pair,
    ...
    /*
     * All 8 parents have now been emitted.
     *
     * Append auth0.
     */
