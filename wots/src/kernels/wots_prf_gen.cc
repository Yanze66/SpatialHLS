    ...
    output_stream<uint32_t> *__restrict output)
{
     ...
     *     base_addr[8]
     *
     * Only ONE input packet is required to generate all 67 PRFs.
     * ============================================================
     */
    ...
    /*
     * ============================================================
     * Precompute SHA256(pub_seed || zero[32]) state ONCE.
     *
     * All 67 WOTS PRFs share the same pub_seed.
     * ============================================================
     */
    ...
    /*
     * ============================================================
     * Generate all 67 WOTS secret-key elements.
     * ============================================================
     */
    ...
    {
        /*
         * Start from the same base address for every chain.
         */
        for (int i = 0; i < 8; ++i)
        {
            addr[i] = base_addr[i];
        ...
        /*
         * ========================================================
         * SHA2 address byte layout:
         *
         * type  = byte 9
         * chain = byte 17
         * hash  = byte 21
         *
         * Our AIE 32-bit representation:
         *
         * byte 9:
         *     addr[2] bits [23:16]
         *
         ...
         * PRF:
         *
         * state = seeded(pub_seed)
         *
         * hash:
         *
         * ADRS^c[22] || SK.seed[32]
         *
         * ========================================================
         */
        ...
        /*
         * ========================================================
         * Reference immediately does:
         *
         *     set_type(addr, SPX_ADDR_TYPE_WOTS)
         *
         * WOTS = 0
         *
         * The first chain tile therefore receives:
         *
         *     chain = chain
         *     hash  = 0
         *     type  = WOTS
